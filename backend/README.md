...
## Project Structure
    ...
    ├── testapiautocatalog_115002  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_115002`
...
2. Clone this repo and `cd testapiautocatalog_115002`
